...
insert into AddressBook(firstname,lastname,address,city,state,zip,phoneno,email) values('pankaj','kumar','Karve Nagar','Pune','MH',456,33344,'pankajroman187@gmail.com')
